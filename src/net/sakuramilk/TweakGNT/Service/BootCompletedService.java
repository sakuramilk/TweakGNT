...
package net.sakuramilk.TweakGNT.Service;

import net.sakuramilk.util.Convert;
import net.sakuramilk.util.RootProcess;
import net.sakuramilk.util.SysFs;
import net.sakuramilk.TweakGNT.CpuControl.CpuControlSetting;
import net.sakuramilk.TweakGNT.Display.DisplaySetting;
import net.sakuramilk.TweakGNT.Dock.DockSetting;
import net.sakuramilk.TweakGNT.General.GeneralSetting;
import net.sakuramilk.TweakGNT.General.LowMemKillerSetting;
import net.sakuramilk.TweakGNT.General.VirtualMemorySetting;
import net.sakuramilk.TweakGNT.SoundAndVib.HwVolumeSetting;
import net.sakuramilk.TweakGNT.SoundAndVib.SoundAndVibSetting;
...
public class BootCompletedService extends Service {
    ...
    private static final String TAG = "TweakGNT::BootCompletedService";
