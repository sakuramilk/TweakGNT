...
package net.sakuramilk.TweakGNT.About;
...
import net.sakuramilk.TweakGNT.General.SystemPropertySetting;
...
public class AboutPreferenceActivity extends PreferenceActivity
    ...
    public boolean onPreferenceClick(Preference preference)
    {
        if (preference == mReset) {
            ...
            Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=net.sakuramilk.TweakGNT");
